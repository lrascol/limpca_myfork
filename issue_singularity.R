...
# from the limpca directory
library(devtools)
# devtools::install()
load_all()

source("R/reshape_mod_mat.R")
...
mae <- readRDS("../limpca_dvpt_Manon/FRESH_LACTIN_V_mae_for_Lucie_20260414.RDS")
...
resLmpBootstrapTests <- lmpBootstrapTests(resLmpEffectMatrices, nboot = 100, verbose = TRUE)
resLmpBootstrapTests

# ASCA

resLmpPcaEffectsASCA <- lmpPcaEffects(resLmpEffectMatrices, method="ASCA",
                                              verbose = TRUE,backtransform = TRUE,
                                              correctedMatrixAdd = FALSE)
str(resLmpPcaEffectsASCA)

## APCA
resLmpPcaEffectsAPCA <- lmpPcaEffects(resLmpEffectMatrices,
                                              method="APCA",
                                              verbose = TRUE,
                                              backtransform = TRUE,
                                              correctedMatrixAdd = FALSE)
str(resLmpPcaEffectsAPCA)

lmpScoreScatterPlotM(resLmpPcaEffectsAPCA,
                     varname.colorup = "arm",
                     varname.colordown = "pid",
                     varname.pchup = "visit_label",
                     varname.pchdown = "visit_label")
